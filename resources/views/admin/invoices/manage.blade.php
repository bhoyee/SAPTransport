...
$(document).ready(function() {
    ...
    let deleteInvoiceId = null;
        ...
        // Function to load data for the cards based on the selected filter
        function loadInvoiceStats(filter) {
        $.ajax({
            ...
            success: function(response) {
                ...
                console.log('Fetched invoice statistics:', response);
                $('#total-paid').text(response.totalPaid);
                $('#total-unpaid').text(response.totalUnpaid);
                $('#total-refunded').text(response.totalRefunded);
            },
